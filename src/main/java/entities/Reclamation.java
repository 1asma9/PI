...
public class Reclamation {
    ...
    private String description; // = contenu dans la DB Symfony
    private Date dateCreation;
    private String statut;
    private String priorite;
    private String reponseAdmin; // = reponse dans la DB Symfony
    ...
    public String toString() {
        return "Reclamation{id=" + id + ", titre='" + titre + "', statut='" + statut + "', priorite='" + priorite + "'}";
    }
}
